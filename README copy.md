...
1. TypeError [ERR_UNESCAPED_CHARACTERS]: Request path contains unescaped characters [#56](https://github.com/huan/gerror/issues/56)
...
fileBox.metadata = {
  author      : 'huan',
  githubRepo  : 'https://github.com/huan/gerror',
}

console.log(fileBox.metadata)       // Output: { author: 'huan', githubRepo: 'https://github.com/huan/gerror' }
...
The currently supported types are defined at [file-box-type.ts](https://github.com/huan/gerror/blob/master/src/file-box.type.ts#L15) as the following demonstrated:
...
1. Suppert ES Module. ([#54](https://github.com/huan/gerror/issues/54))
...
1. Throw error when consume a stream twice to prevent data lost. ([#50](https://github.com/huan/gerror/issues/50))
...
1. Add `chunkerTransformStream` to `toStream` ([#44](https://github.com/huan/gerror/issues/44))

### v0.12 (Feb 2020)

Add support to `JSON.stringify()` ([#25](https://github.com/huan/gerror/issues/25)):
...
1. Add `metadata` property to store additional information. ([#3](https://github.com/huan/gerror/issues/3))
